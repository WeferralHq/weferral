...
export class ClickVsConvMetrics extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            CHART_LENGTH: this.props.CHART_LENGTH,
    ...
    dataGenerator(index){
        let self = this;
        const CHART_START_DATE = moment().subtract(self.state.CHART_LENGTH, 'months');
        const referenceValue = _.random(0, self.state.clickData.length);
        const halfedRefVal = referenceValue / 2;
        ...
        return {
            ...
            "Tokyo": referenceValue,
            "New York": _.random(1200, 2200),
            "Conversions": referenceValue - _.random(halfedRefVal, halfedRefVal * 1.1),
        };
    }
